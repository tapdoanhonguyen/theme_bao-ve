...
if (!nv_function_exists('nv_block_projects')) {
    /**
     * nv_block_config_projects()
     *
     * @param mixed $module
     ...
     * @return
     */
    function nv_block_config_projects($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_projects_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_config_projects_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     * @return
     */
    function nv_block_projects($block_config)
    {
        ...
        if (!empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/news/block_projects.tpl')) {
                $block_theme = $global_config['module_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('block_projects.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/news');
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_projects($block_config);
    }
}