...
<div class="container-fluid nvwrap">
	...
	<section id="middle" class="row">
		<aside id="left-menu">
			<div id="bg-left-menu" style="padding-left: 4px;width: 240px;">
				<div class="logo">
			<a title="{NV_SITE_NAME}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
				...
				<ul class="nav nav-pills nav-stacked text-color">
					<!-- BEGIN: menu_loop -->
						<li {MENU_CLASS}>
							<a href="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MENU_HREF}"><em
		...
		<div class="menu pull-right">
            ...
            <div title="{NV_LANGINTERFACE}" >
                ...
                <div class="dropdown-menu" role="menu">
                    <!-- BEGIN: option -->
                    <div{DISABLED}><a href="{LANGOP}">{LANGVALUE}</a></div>
                    <!-- END: option -->
                </div>
            </div>            
            <!-- END: langinterface -->        
			<!-- BEGIN: langdata -->
			<div title="{NV_LANGDATA}">
				<a href="javascript:void(0);" data-toggle="dropdown">
			...
			<!-- END: langdata -->
			<div class="tip fixright" data-toggle="tooltip" data-placement="bottom" title="{NV_GO_CLIENTSECTOR}">
				<a href="{NV_GO_CLIENTSECTOR_URL}"> <em class="fa fa-home fa-2x fix">&nbsp;</em></a>
			</div>
			<div class="tip admin-info fixright" data-toggle="tooltip" data-placement="bottom" title="<!-- BEGIN: hello_admin -->{HELLO_ADMIN1}<!-- END: hello_admin --><!-- BEGIN: hello_admin3 -->{HELLO_ADMIN3}<!-- END: hello_admin3 --><!-- BEGIN: hello_admin2 -->{HELLO_ADMIN2}<!-- END: hello_admin2 -->">
			...
			<!-- BEGIN: notification -->
			<div class="dropdown fixright" id="notification-area">
			...
			<!-- END: notification -->
			<div class="tip fixright" data-toggle="tooltip" data-placement="bottom" title="{NV_LOGOUT}">
